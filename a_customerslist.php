	...
	function Page_Init() {
		...
		if ($_SESSION['gsExport']=='print') {
			if (!$_SESSION['Security']->CanExportToPrint() && !$_SESSION['Security']->IsAdmin()) {
				echo htmlspecialchars($_SESSION['Language']->Phrase('nopermission'));
...
// End of modification Disable/Enable Registration Page, by Masino Sinaga, May 14, 2012
		...
		// Check token
		if (!$this->ValidPost()) {
			echo htmlspecialchars($_SESSION['Language']->Phrase('InvalidPostRequest'));
			$this->Page_Terminate();
		...
		if ($_POST['ajax'] == 'autofill') {
			...
			if ($_POST['grid'] == 'fa_salesgrid') {
				if (!isset( $_SESSION['a_sales_grid']))  $_SESSION['a_sales_grid'] = new ca_sales_grid;
                $_SESSION['a_sales_grid']->Page_Init();
				$this->Page_Terminate();
...
// End of modification Customize Navigation/Pager Panel, by Masino Sinaga, May 2, 2012
	...
	function SetupKeyValues($key) {
		$arrKeyFlds = explode( $_SESSION['EW_COMPOSITE_KEY_SEPARATOR'], $key);
...
<?php echo htmlspecialchars($_SESSION['Language']->SelectionForm()); ?>
<?php } ?>
<?php } ?>
<?php } ?>
...
<div id="xsr_1" class="ewRow">
	...
	<div class="input-group-btn">
		...
		<ul class="dropdown-menu pull-right" role="menu">
			<li<?php if ($a_customers_list->BasicSearch->getType() == '') echo ' class=\"active\"'; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this)"><?php echo htmlspecialchars($_SESSION['Language']->Phrase('QuickSearchAuto')) ?></a></li>
			<li<?php if ($a_customers_list->BasicSearch->getType() == '=') echo ' class=\"active\"'; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'=')"><?php echo htmlspecialchars($_SESSION['Language']->Phrase('QuickSearchExact')) ?></a></li>
			<li<?php if ($a_customers_list->BasicSearch->getType() == 'AND') echo ' class=\"active\"'; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'AND')"><?php echo htmlspecialchars($_SESSION['Language']->Phrase('QuickSearchAll')) ?></a></li>
			<li<?php if ($a_customers_list->BasicSearch->getType() == 'OR') echo ' class=\"active\"'; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'OR')"><?php echo htmlspecialchars($_SESSION['Language']->Phrase('QuickSearchAny')) ?></a></li>
		</ul>
	<button class="btn btn-primary ewButton" name="btnsubmit" id="btnsubmit" type="submit"><?php echo htmlspecialchars($_SESSION['Language']->Phrase('QuickSearchBtn')) ?></button>
	</div>
	</div>
</div>
	</div>
...
<thead><!-- Table header -->
    ...
    <?php
        ...
        echo htmlspecialchars($html6->html06($a_customers, $_SESSION['Language']));
    ?>
	</tr>
</thead>
<tbody>
...
<span class="ewAggregate"><?php echo htmlspecialchars($_SESSION['Language']->Phrase('TOTAL')) ?></span>
...
<div class="ewPager"><span>&nbsp;<?php echo htmlspecialchars($_SESSION['Language']->Phrase('RecordsPerPage')) ?>&nbsp;</span>
<input type="hidden" name="t" value="a_customers">
...
foreach ($sRecPerPageList as $a) {
    $thisDisplayRecs = $a;
    ?>
    <option value="<?php if($thisDisplayRecs > 0 ){echo $thisDisplayRecs;}else{echo "ALL";}?>" <?php if(($thisDisplayRecs > 0 && $a_customers_list->DisplayRecs == $thisDisplayRecs) || $a_customers->getRecordsPerPage() == -1){ ?>selected="selected"<?php } ?>><?php if($thisDisplayRecs > 0){echo $thisDisplayRecs;}else{echo htmlspecialchars($_SESSION['Language']->Phrase('AllRecords'));}?></option>
<?php } ?>
</select>
</div>
<?php } ?>
		<?php if (MS_PAGINATION_STYLE==1 && !isset($a_customers_list->Pager)) $a_customers_list->Pager = new cNumericPager($a_customers_list->StartRec, $a_customers_list->DisplayRecs, $a_customers_list->TotalRecs, $a_customers_list->RecRange) ?>
				<?php if ((MS_PAGINATION_STYLE==1 && $a_customers_list->Pager->RecordCount > 0) && (($a_customers_list->Pager->PageCount!=1) || ($a_customers_list->Pager->CurrentPage != 1) || (MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==TRUE)) ) { ?>
				    <?php
                    $html= new cod_html();
				    echo htmlspecialchars($html->codhtml($a_customers_list, $_SESSION['Language']));
				    ?>
        ...
        <?php if (MS_PAGINATION_STYLE==1 && $a_customers_list->Pager->RecordCount > 0) { ?>
            <?php
                $html2= new cod_html();
                echo htmlspecialchars($html2->codhtml2($_SESSION['Language'], $a_customers_list));
            ?>
		<?php } ?>
...
<?php if ($a_customers->Customer_Number->Visible) { // Customer_Number ?>
	...
	<?php } else { ?>
		<th data-name="Customer_Number"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $a_customers->SortUrl($a_customers->Customer_Number) ?>',1);"><div id="elh_a_customers_Customer_Number" class="a_customers_Customer_Number">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $a_customers->Customer_Number->FldCaption() ?><?php echo htmlspecialchars($_SESSION['Language']->Phrase('SrchLegend')) ?></span><span class="ewTableHeaderSort"><?php if ($a_customers->Customer_Number->getSort() == 'ASC') { ?><span class="caret ewSortUp"></span><?php } elseif ($a_customers->Customer_Number->getSort() == 'DESC') { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($a_customers->Customer_Name->Visible) { // Customer_Name ?>
	...
	<?php } else { ?>
		<th data-name="Customer_Name"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $a_customers->SortUrl($a_customers->Customer_Name) ?>',1);"><div id="elh_a_customers_Customer_Name" class="a_customers_Customer_Name">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $a_customers->Customer_Name->FldCaption() ?><?php echo htmlspecialchars($_SESSION['Language']->Phrase('SrchLegend')) ?></span><span class="ewTableHeaderSort"><?php if ($a_customers->Customer_Name->getSort() == 'ASC') { ?><span class="caret ewSortUp"></span><?php } elseif ($a_customers->Customer_Name->getSort() == 'DESC') { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($a_customers->Contact_Person->Visible) { // Contact_Person ?>
	...
	<?php } else { ?>
		<th data-name="Contact_Person"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $a_customers->SortUrl($a_customers->Contact_Person) ?>',1);"><div id="elh_a_customers_Contact_Person" class="a_customers_Contact_Person">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $a_customers->Contact_Person->FldCaption() ?><?php echo htmlspecialchars($_SESSION['Language']->Phrase('SrchLegend')) ?></span><span class="ewTableHeaderSort"><?php if ($a_customers->Contact_Person->getSort() == 'ASC') { ?><span class="caret ewSortUp"></span><?php } elseif ($a_customers->Contact_Person->getSort() == 'DESC') { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($a_customers->Phone_Number->Visible) { // Phone_Number ?>
	...
	<?php } else { ?>
		<th data-name="Phone_Number"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $a_customers->SortUrl($a_customers->Phone_Number) ?>',1);"><div id="elh_a_customers_Phone_Number" class="a_customers_Phone_Number">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $a_customers->Phone_Number->FldCaption() ?><?php echo htmlspecialchars($_SESSION['Language']->Phrase('SrchLegend')) ?></span><span class="ewTableHeaderSort"><?php if ($a_customers->Phone_Number->getSort() == 'ASC') { ?><span class="caret ewSortUp"></span><?php } elseif ($a_customers->Phone_Number->getSort() == 'DESC') { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($a_customers->Mobile_Number->Visible) { // Mobile_Number ?>
	...
	<?php } else { ?>
		<th data-name="Mobile_Number"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $a_customers->SortUrl($a_customers->Mobile_Number) ?>',1);"><div id="elh_a_customers_Mobile_Number" class="a_customers_Mobile_Number">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $a_customers->Mobile_Number->FldCaption() ?><?php echo htmlspecialchars($_SESSION['Language']->Phrase('SrchLegend')) ?></span><span class="ewTableHeaderSort"><?php if ($a_customers->Mobile_Number->getSort() == 'ASC') { ?><span class="caret ewSortUp"></span><?php } elseif ($a_customers->Mobile_Number->getSort() == 'DESC') { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($a_customers->Balance->Visible) { // Balance ?>
	...
	<?php } else { ?>
		<th data-name="Balance"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $a_customers->SortUrl($a_customers->Balance) ?>',1);"><div id="elh_a_customers_Balance" class="a_customers_Balance">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $a_customers->Balance->FldCaption() ?><?php echo htmlspecialchars($_SESSION['Language']->Phrase('SrchLegend')) ?></span><span class="ewTableHeaderSort"><?php if ($a_customers->Balance->getSort() == 'ASC') { ?><span class="caret ewSortUp"></span><?php } elseif ($a_customers->Balance->getSort() == 'DESC') { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<?php } ?>
        ...
        <?php if (MS_PAGINATION_STYLE==1 && $a_customers_list->Pager->RecordCount > 0) { ?>
            <?php
            $html2 = new cod_html();
            echo htmlspecialchars($html2->codhtml2($a_customers_list, $_SESSION['Language']));
            ?>
		<?php } ?>
		<?php if (MS_PAGINATION_STYLE==2 && !isset($a_customers_list->Pager)) $a_customers_list->Pager = new cPrevNextPager($a_customers_list->StartRec, $a_customers_list->DisplayRecs, $a_customers_list->TotalRecs) ?>
				...
				<div class="ewPager">
				<span><?php echo htmlspecialchars($_SESSION['Language']->Phrase('Page')) ?>&nbsp;</span>
				...
				<span>&nbsp;<?php echo htmlspecialchars($_SESSION['Language']->Phrase('of')) ?>&nbsp;<?php echo $a_customers_list->Pager->PageCount ?></span>
				</div>
				<?php } // end MS_SHOW_PAGENUM_IF_REC_NOT_OVER_PAGESIZE==FALSE ?>
        <?php if (MS_PAGINATION_STYLE==2 && $a_customers_list->Pager->RecordCount > 0) { ?>
				<div class="ewPager ewRec">
					<span><?php echo htmlspecialchars($_SESSION['Language']->Phrase('Record')) ?>&nbsp;<?php echo $a_customers_list->Pager->FromIndex ?>&nbsp;<?php echo htmlspecialchars($_SESSION['Language']->Phrase('To')) ?>&nbsp;<?php echo $a_customers_list->Pager->ToIndex ?>&nbsp;<?php echo htmlspecialchars($_SESSION['Language']->Phrase('Of')) ?>&nbsp;<?php echo htmlspecialchars($a_customers_list->Pager->RecordCount) ?></span>
				</div>
		<?php } ?>
